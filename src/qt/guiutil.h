...
/** Utility functions used by the DesignCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render DesignCoin addresses in monospace font
...
// Parse "designcoin:" URI into recipient object, return true on successful parsing
