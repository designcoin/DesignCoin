...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"designcoin", "masternodelist", &masternodelist, true, true, false},
        {"designcoin", "mnbudget", &mnbudget, true, true, false},
        {"designcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26238/\n";
}
