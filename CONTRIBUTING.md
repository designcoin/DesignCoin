Contributing to DesignCoin Core
============================

The DesignCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DesignCoin Core project, and is not to be
confused with overall DesignCoin Network Protocol consensus changes.

Whether a pull request is merged into DesignCoin Core rests with the project merge
...
Patches that change DesignCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the DesignCoin consensus, it must have been
...
The project leader is the release manager for each DesignCoin Core release.
