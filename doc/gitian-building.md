...
- The VM will detect network settings using DSNP, this should all proceed automatically
...
git clone https://github.com/designcoin-crypto/designcoin.git
cd designcoin
...
```bash
    ...
    From https://github.com/designcoin-crypto/designcoin
...
For example:
```bash
URL=https://github.com/crowning-/designcoin.git
...
[designcoin/gitian.sigs](https://github.com/designcoin-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
