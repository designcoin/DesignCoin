...
In order to support loading of multiple wallets in designcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is designcoin.cpp.
...
Changes to designcoin.cpp
----------------------
designcoin.cpp is the entry point into designcoin-qt, and as such, will require some minor modifications to provide hooks for
